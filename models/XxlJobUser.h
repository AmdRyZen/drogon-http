...
class XxlJobUser
{
  public:
     ...
     */
    explicit XxlJobUser(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit XxlJobUser(const Json::Value &pJson) noexcept(false);
     ...
     */
    XxlJobUser(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<XxlJobUser>;
    friend drogon::orm::BaseBuilder<XxlJobUser, true, true>;
    friend drogon::orm::BaseBuilder<XxlJobUser, true, false>;
    friend drogon::orm::BaseBuilder<XxlJobUser, false, true>;
    friend drogon::orm::BaseBuilder<XxlJobUser, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<XxlJobUser>;
#endif
