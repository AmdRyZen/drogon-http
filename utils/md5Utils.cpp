...
void md5Utils::MD5Init(MD5_CTX *context) {
    context->count[0]=0;
    context->count[1]=0;
...
void md5Utils::MD5Final(MD5_CTX *context, unsigned char *digest) {
...
void md5Utils::MD5Transform(unsigned int *state, unsigned char *block) {
